...
abstract class Filter extends PolymerElement with ChangeNotifier  {
  ...
  @reflectable @published Map<String,Map<String,String>> get filters => __$filters; Map<String,Map<String,String>> __$filters; @reflectable set filters(Map<String,Map<String,String>> value) { __$filters = notifyPropertyChange(#filters, __$filters, value); }//={"a":{"b":"c"},"d":{"e":"h"}};
