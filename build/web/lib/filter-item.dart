...
class FilterItem extends PolymerElement with ChangeNotifier  {
  @reflectable @published Map<String, dynamic> get filtermap => __$filtermap; Map<String, dynamic> __$filtermap; @reflectable set filtermap(Map<String, dynamic> value) { __$filtermap = notifyPropertyChange(#filtermap, __$filtermap, value); }//={"a":{"b":"c"},"d":{"e":"h"}};
