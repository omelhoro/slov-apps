...
@CustomTag("memo-app")
class MemoApp extends Filter with ChangeNotifier  {
  List<Map<String, dynamic>> oriDb;
  @reflectable @published List<List<dynamic>> get rows => __$rows; List<List<dynamic>> __$rows = toObservable([]); @reflectable set rows(List<List<dynamic>> value) { __$rows = notifyPropertyChange(#rows, __$rows, value); }
