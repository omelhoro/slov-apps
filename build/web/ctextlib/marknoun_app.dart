...
class NounMarker extends WordfApp with ChangeNotifier  {
  List<WordForm> allNouns;
  List<LIElement> allCases;
  int curIx,
      curCaseIx = 0;
  @reflectable @observable String get curCaseClass => __$curCaseClass; String __$curCaseClass; @reflectable set curCaseClass(String value) { __$curCaseClass = notifyPropertyChange(#curCaseClass, __$curCaseClass, value); }
  List<String> poss = [];
  @reflectable @observable Map<String, List<dynamic>> get stats => __$stats; Map<String, List<dynamic>> __$stats = toObservable({
    "Unmarked": ["label-default", 0],
    "Correct": ["label-success", 0],
    "False": ["label-danger", 0]
  }); @reflectable set stats(Map<String, List<dynamic>> value) { __$stats = notifyPropertyChange(#stats, __$stats, value); }
  var keyListener;
